  ...
  return (
    <GlassCard transition={{ delay: index * 0.07 }}>
      ...
      <div className="mt-6 space-y-3 text-sm">
        ...
        />
        <Row label="Status" value={transaction.status.replace('_', ' ')} capitalize />
      </div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200/80 bg-white/60 py-2.5 text-sm font-medium text-slate-800 transition hover:border-db-blue/40 hover:text-db-blue dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:text-blue-300"
      >
        View Details
